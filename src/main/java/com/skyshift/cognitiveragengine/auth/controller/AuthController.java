...
public class AuthController {
    ...
    @GetMapping("/me")
    public ResponseEntity<UserSummaryResponse> me(@AuthenticationPrincipal AuthenticatedUser principal) {
        UserSummaryResponse response = userService.getCurrentUser(principal.getId());
